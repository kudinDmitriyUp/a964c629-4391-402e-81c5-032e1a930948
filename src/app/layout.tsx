...
export const metadata: Metadata = {
  title: "Розроби очко | Українська IT компанія",
  description: "Розроби очко - українська IT компанія з експертизою у веб-розробці, мобільних додатках та облачних рішеннях. Трансформуємо бізнес через інновації.",
  keywords: "IT компанія, веб-розробка, мобільні додатки, облачні рішення, Україна, розробка ПО",
  metadataBase: new URL('https://rozroby-ochko.com'),
  alternates: {
    canonical: 'https://rozroby-ochko.com'
  },
  openGraph: {
    title: "Розроби очко | Українська IT компанія",
    description: "Комплексні IT рішення для трансформації вашого бізнесу. Розробка веб та мобільних додатків.",
    siteName: "Розроби очко",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764601692392-j8658rjh.jpg",
      alt: "Розроби очко - IT рішення"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Розроби очко | Українська IT компанія",
    description: "Інноваційні IT рішення для вашого бізнесу",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764601692392-j8658rjh.jpg"]
  },
  robots: {
    index: true,
    follow: true
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <PostHogWrapper>
        <body
          className={`${interTight.variable} ${merriweather.variable} antialiased`}
        >
          <Tag />
          {children}
